  ...
  return (
    <div className="relative group p-4 -mx-4 rounded-lg hover:bg-zinc-50/80 border border-transparent hover:border-zinc-200 transition-all my-1 print:p-0 print:m-0 print:border-none print:hover:bg-transparent">
       <button
         ...
         className="absolute top-4 right-4 p-2 bg-white border border-zinc-200 rounded-md shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-200 text-zinc-400 hover:text-zinc-900 print:hidden z-10"
