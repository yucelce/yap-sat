...
// 1. DÜZELTME: Alt bileşeni ana bileşenin DIŞINA çıkardık.
// Böylece gereksiz re-render ve odak (focus) kaybetme sorununu çözdük.
...
const InlineInput: React.FC<InlineInputProps> = ({ name, value, onChange }) => (
  <input
    type="text"
    name={name}
    value={value}
      ...
      <div className="w-full max-w-[210mm] min-h-[297mm] bg-white p-10 sm:p-16 shadow-2xl ring-1 ring-gray-900/5 print:shadow-none print:ring-0 print:p-0">
        ...
        <div className="space-y-8 text-gray-800 leading-relaxed text-justify text-lg print:text-base">
          <p>
            ...
            <InlineInput name="muteahhit" value={formData.muteahhit} onChange={handleChange} />
            (bundan böyle <strong>"MÜTEAHHİT"</strong> olarak anılacaktır) ile diğer tarafta mukim
            <InlineInput name="arsaSahibi" value={formData.arsaSahibi} onChange={handleChange} />
          ...
          <p>
            ...
            <InlineInput name="adres" value={formData.adres} onChange={handleChange} />
            ...
            <InlineInput name="oran" value={formData.oran} onChange={handleChange} />
          ...
          <p>
            ...
            İşbu sözleşme
            <InlineInput name="tarih" value={formData.tarih} onChange={handleChange} />
